...
public class Fragment_table extends Fragment {
    private static final String URL = "https://furniturebd.000webhostapp.com/view_table.php";
    ...
    private void setupRecyclerView(RecyclerView recyclerview) {
        ...
        recyclerview.addItemDecoration(new Fragment_table.GridSpacingItemDecoration(2, dpToPx(10), true));
